...
public class EpisodePosition
{
    ...
    @Generated(hash = 1845189713)
    private transient EpisodePositionDao myDao;

    @Generated(hash = 648555048)
    public EpisodePosition(Long _id, long episodeId, int position) {
        this._id = _id;
        this.episodeId = episodeId;
        this.position = position;
    }

    @Generated(hash = 1292904650)
    ...
    /** called by internal mechanisms, do not call yourself. */
    @Generated(hash = 1432072037)
    public void __setDaoSession(DaoSession daoSession) {
        this.daoSession = daoSession;
        myDao = daoSession != null ? daoSession.getEpisodePositionDao() : null;
    }
}
